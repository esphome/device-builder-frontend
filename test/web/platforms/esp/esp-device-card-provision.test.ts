...
vi.mock(
  "../../../../src/web/platforms/esp/esphome-web-install-adoptable-dialog.js",
  () => ({})
);
vi.mock(
  "../../../../src/web/platforms/esp/esphome-web-install-upload-dialog.js",
  () => ({})
);
...
import { ESPHomeWebEspDeviceCard } from "../../../../src/web/platforms/esp/esphome-web-esp-device-card.js";
